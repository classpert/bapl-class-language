...
-- <root>/lesson-5/exercies/components_04/machine.lua       <- implementation of our stack machine (very simple).
-- <root>/lesson-5/exercies/components_04/compiler.lua      <- compiler that generates code for the machine from arithmetic

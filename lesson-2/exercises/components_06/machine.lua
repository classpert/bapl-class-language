...
Machine.OPCODES.EQ   = 8 -- Pop 2 elements TOS(0), TOS(1) and push the comparsion TOS(1) == TOS(0) to TOS(0)
Machine.OPCODES.NEQ  = 9 -- Pop 2 elements TOS(0), TOS(1) and push the comparsion TOS(1) != TOS(0) to TOS(0)
Machine.OPCODES.LT   = 10 -- Pop 2 elements TOS(0), TOS(1) and push the comparsion TOS(1) < TOS(0) to TOS(0)
Machine.OPCODES.LE   = 11 -- Pop 2 elements TOS(0), TOS(1) and push the comparsion TOS(1) <= TOS(0) to TOS(0)
Machine.OPCODES.GT   = 12 -- Pop 2 elements TOS(0), TOS(1) and push the comparsion TOS(1) > TOS(0) to TOS(0)
Machine.OPCODES.GE   = 13 -- Pop 2 elements TOS(0), TOS(1) and push the comparsion TOS(1) >= TOS(0) to TOS(0)
Machine.OPCODES.NEG  = 14 -- Pop1 element TOS(0) and push the negation -TOS(1) to the stack.

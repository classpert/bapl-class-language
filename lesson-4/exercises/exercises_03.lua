...
-- <root>/lesson-4/exercies/components_03/machine.lua       <- implementation of our stack machine (very simple).
-- <root>/lesson-4/exercies/components_03/compiler.lua      <- compiler that generates code for the machine from arithmetic

...
--
-- Exercise 4: Matching the whole subject
--
...
--
local sum = whitespace_wrapped(lpeg.C(number)) * (lpeg.Cp() * plus * whitespace_wrapped(lpeg.C(number)))^0 * -lpeg.P(1)
...
TestExpression = {}
    function TestExpression:testSum3()
